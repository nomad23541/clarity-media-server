...
module.exports.search = function(params) {
    // primary release year (instead of year) works better for movies with the same title but different years
    return new Promise(function(resolve, reject) {
        requestLimit('/3/search/movie?query=' + params.title + '&primary_release_year=' + params.year + '&api_key=' + params.apiKey, function(err, res, body) {
